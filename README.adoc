= Building C Executables image:https://travis-ci.org/gradle-guides/building-c-executables.svg?branch=master["Build Status", link="https://travis-ci.org/gradle-guides/building-c-executables?branch=master"]
